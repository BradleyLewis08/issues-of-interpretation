...
export default function FirstPage() {
  ...
  <Heading color={'black'} position="absolute" left="200px" marginRight ='600px' top="180px" marginTop ='0px'>Introduction and Goals </Heading>
...
<Button colorScheme='blue' marginLeft ='1200px' marginTop ='570px' onClick={() => navigate('/secondpage')}>Next</Button>
